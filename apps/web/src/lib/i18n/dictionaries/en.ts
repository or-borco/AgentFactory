const en = {
  ...
  agentMemory: {
    title: "Memory",
    emptyState: "No memory entries yet. This agent will start remembering things as it works, or when you tell it to.",
    sourceManual: "Told to remember",
    sourceRetrospective: "Learned from a task",
    reinforcedLabel: "Reinforced {count}x",
    editButton: "Edit",
    saveButton: "Save",
    cancelButton: "Cancel",
    deleteButton: "Delete",
    confirmDeleteTitle: "Delete this memory entry?",
    confirmDeleteMessage: "The agent will no longer be reminded of this in future sessions. This can't be undone.",
    confirmDeleteButton: "Delete",
    loadError: "Couldn't load this agent's memory.",
    saveFailed: "Couldn't save that edit. Try again.",
    deleteFailed: "Couldn't delete that entry. Try again.",
    history: {
      toggleWhy: "Why was this learned?",
      toggleHistory: "History",
      hide: "Hide history",
      loadError: "Couldn't load this entry's history.",
      empty: "No history recorded for this entry.",
      toldToRemember: "Told to remember",
      noReason: "No reason recorded",
      editedBy: "Edited by {name}",
      formerMember: "a former member",
      beforeEdit: "(before edit)",
      fromTask: "From: {ref} · {title}",
      fromSession: "From: session {id}",
      decryptError: "This record couldn't be read.",
      limitNote: "Showing only the latest {count} changes.",
    },
  },
  agentForm: {
    newTitle: "New agent",
  ...
  connections: {
    ...
    telegram: {
      ...
      modalTitle: "Connect a Telegram bot",
      botToken: "Bot token",
      botTokenHelp: "Create a bot via @BotFather on Telegram and paste the token it gives you.",
      agent: "Agent",
      agentHelp: "The agent this bot will work on behalf of. Users who message this bot will be working with this agent.",
      agentPlaceholder: "Select an agent",
      verifyFailed: "Couldn't verify this bot token. Check it and try again.",
      alreadyConnected: "Already connected to {label}. Disconnect it before connecting another.",
    },
    telegramChannel: {
      configureLabel: "Manage access",
      inviteCodesTitle: "Invite codes",
      generateCode: "Generate code",
      deepLinkCopied: "Invite link copied",
      ...
      noAuthorizedUsers: "No one has redeemed an invite yet.",
      generateFailed: "Couldn't generate an invite code. Try again.",
    },
  },
  tasks: {
    title: "Tasks",
  ...
  taskCreate: {
    linkedIssue: {
      fromIssueLabel: "From {provider} issue",
      fromIssueLabelDisabled: "From issue",
      disabledTooltip: "Connect a task-tracking tool in Settings → Connections to link an issue",
      refPlaceholder: "Issue key or URL",
      fetch: "Fetch",
      fetching: "Fetching…",
      fetchFailed: "Couldn't fetch that issue. Check the key or URL and try again.",
      attachmentsLabel: "Attachments from issue",
    },
  },
  taskDetail: {
    ...
    revertToAssigned: "Revert to assigned",
    revertingToAssigned: "Reverting…",
    ...
    contextOmittedNoMemoryEntries: "Not included: this agent has no memory entries yet",
    contextOmittedReviewTurn: "Not included: the remember tool isn't available on PR-review turns",
    ...
    contextLayerAgentMemory: "Agent memory",
    contextLayerRememberReminder: "Remember reminder",
    ...
    linkedIssue: {
      ...
      badge: "{provider} {key}",
      attachmentsLabel: "Issue attachments",
      attachmentIndexed: "Indexed",
      attachmentFailed: "Not available",
      attachmentPending: "Processing…",
      viewInProvider: "View in {provider}",
    },
    sync: {
      refresh: "Refresh",
      refreshTooltip: "Check the linked issue for changes",
      refreshing: "Checking…",
      upToDate: "Up to date",
      dialogTitle: "The linked issue has changed",
      dialogBody: "This issue was updated since it was last synced. Review the changes below.",
      oldLabel: "Current",
      newLabel: "Latest from {provider}",
      attachmentsLabel: "New attachments",
    ...
    reviewPendingTitle: "Pending approval",
    reviewApproveButton: "Approve & post to GitHub",
  ...
  toast: {
    ...
    taskReverted: "Task reverted to assigned",
    taskStopped: "Agent stopped",
